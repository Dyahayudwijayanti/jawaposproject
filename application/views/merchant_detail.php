   ...
   <div class="aa-catg-head-banner-area">
     <div class="container">
      <div class="aa-catg-head-banner-content">
        <h2><?php echo $detail->NAME_MERCHANT;?></h2>
        <ol class="breadcrumb">
              ...
              <div class="col-md-12">
                ...
                <div class="aa-blog-content aa-blog-details">
                  <article class="aa-blog-content-single">                        
                    <h2><a href="#"><?php echo $detail->NAME_MERCHANT;?></a></h2>
                     <div class="aa-article-bottom">
                      <div class="aa-post-author">
                          <h4><?php echo $detail->PHONE_MERCHANT;?></h4>
                      </div>
                    </div>
                    <p><?php echo $detail->LOCATION_MERCHANT;?></p>
                    ...
                    <div class="comments">
                      <ul class="commentlist">
                        <li>
                          <div class="media">
                            <div class="media-left">    
                                <img class="media-object news-img" src="<?php echo base_url();?>assets/img/testimonial-img-3.jpg" alt="img">      
                            </div>
                        ...
                        <li>
                          <div class="media">
                            <div class="media-left">    
                                <img class="media-object news-img" src="<?php echo base_url();?>assets/img/testimonial-img-2.jpg" alt="img">      
                            </div>
                            <div class="media-body">
                             <h4 class="author-name">Charlie Balley</h4>
                             <span class="comments-date"> March 26th 2016</span>
